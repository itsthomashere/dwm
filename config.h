...
static const Key keys[] = {
    ...
    TAGKEYS (XK_bracketleft, 0) TAGKEYS (XK_bracketright, 1)
        TAGKEYS (XK_braceleft, 2) TAGKEYS (XK_braceright, 3)
            TAGKEYS (XK_percent, 4) TAGKEYS (XK_asciicircum, 5)
                TAGKEYS (XK_plus, 6) TAGKEYS (XK_asterisk, 7)
                    TAGKEYS (XK_parenleft, 8) TAGKEYS (XK_parenright, 9){
